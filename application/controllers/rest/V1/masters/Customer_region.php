...
class Customer_region extends REST_Controller
{
    public $error;
		public $logs;
		public $log_json;
  ...
  public function __construct()
  {
	...
	public function get_get($id = NULL)
	{
		...
		{
			$ds = $this->customer_region_model->get_all();
    ...
    $json = file_get_contents("php://input");
	  ...
	  if($sc === TRUE)
	  {
		...
		if($sc === TRUE)
		{
			...
			$this->logs_model->logs_customer_region($logs);
	...
	public function update_post($id)
  {
	...
	public function delete_post($id)
	{
		...
		if(! $this->customer_region_model->delete($id))
		{
			$sc = FALSE;
