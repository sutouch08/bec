<div class="row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-1 table-responsive" style="padding:0px; margin-left:5px; height:400px; overflow:auto;">
		<table class="table table-bordered border-1 tableFixHead table-narrow" style="min-width:2080px;">
			<thead>
				<tr class="freez">
					...
					<?php foreach ($details as $rs) : ?>
						...
						<?php if ($rs->type == 0) : ?>
							<tr id="row-<?php echo $uid; ?>">
								...
								<input type="hidden" class="line-num" id="line-num-<?php echo $uid; ?>" value="<?php echo $no; ?>" />
								...
								<input type="hidden" id="policy-id-<?php echo $uid; ?>" value="<?php echo $rs->policy_id; ?>" />
								...
								<td class="middle text-center fix-type" scope="row">
									<select class="form-control input-sm toggle-text" id="type-<?php echo $uid; ?>" onchange="toggleText($(this))" data-id="<?php echo $uid; ?>">
								...
								<td class="middle fix-code" scope="row">
									<input type="text" class="form-control input-sm item-code" data-id="<?php echo $uid; ?>" id="itemCode-<?php echo $uid; ?>" value="<?php echo escape_str($rs->ItemCode); ?>" />
								</td>
								<td class="middle fix-desc" scope="row">
									<input type="text" class="form-control input-sm item-name" data-id="<?php echo $uid; ?>" id="itemName-<?php echo $uid; ?>" value="<?php echo escape_str($rs->ItemName); ?>" />
								</td>
								<td class="middle">
								...
								<td class="middle">
									<input type="text" class="form-control input-sm text-right" id="instock-<?php echo $uid; ?>" value="<?php echo $rs->instock; ?>" disabled />
								</td>
								<td class="middle">
								...
								<td class="middle">
									<input type="text" class="form-control input-sm text-right" id="team-<?php echo $uid; ?>" value="<?php echo $rs->team; ?>" disabled />
								</td>
								<td class="middle">
									<input type="text" class="form-control input-sm text-right" id="commit-<?php echo $uid; ?>" value="<?php echo $rs->commit; ?>" disabled />
								</td>
								<td class="middle">
									<input type="text" class="form-control input-sm text-right" id="available-<?php echo $uid; ?>" value="<?php echo $rs->available; ?>" disabled />
								</td>
								<td class="middle">
								...
								<td class="middle">
									<input type="number" class="form-control input-sm text-right line-qty"
										...
										value="<?php echo $rs->Qty; ?>" onkeyup="recalAmount('<?php echo $uid; ?>')" />
								</td>
								<td class="middle">
								...
								<td class="middle">
									<input type="text" class="form-control input-sm text-right number price"
										data-id="<?php echo $uid; ?>" id="price-label-<?php echo $uid; ?>"
										value="<?php echo number($rs->Price, 2); ?>" />
								</td>
								<td class="middle">
									<input type="text" class="form-control input-sm text-right " id="disc-label-<?php echo $uid; ?>"
										value="<?php echo $rs->discLabel; ?>" onchange="recalDiscount('<?php echo $uid; ?>')" />
								</td>
								<td class="middle">
						...
						<?php else : ?>
							<tr id="row-<?php echo $uid; ?>">
								...
								<td colspan="3" class="fix-text" scope="row">
									<textarea id="text-<?php echo $uid; ?>" class="autosize autosize-transition width-100" style="height:100px;"><?php echo $rs->LineText; ?></textarea>
								</td>
								<td colspan="14"></td>
							</tr>
						<?php endif; ?>
