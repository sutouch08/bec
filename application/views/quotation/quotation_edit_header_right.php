<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 padding-5 last">
	<div class="form-horizontal">
		<div class="form-group">
			<label class="col-lg-8-harf col-md-8 col-sm-7 col-xs-12 sap-label">Web No.</label>
		...
		<div class="form-group">
			<label class="col-lg-8-harf col-md-8 col-sm-7 col-xs-12 sap-label">Original SQ</label>
			<div class="col-lg-3-harf col-md-4 col-sm-5 col-xs-12">
				<input type="text" id="orignal-code" class="form-control input-sm" value="<?php echo $order->OriginalSQ; ?>" disabled />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3-harf col-md-4 col-sm-5 col-xs-12">
				<span class="input-icon input-icon-right">
					<input type="text" id="DocDate" class="form-control input-sm r" value="<?php echo thai_date($order->DocDate, FALSE); ?>" readonly />
