...
<form id="searchForm" method="post" action="<?php echo current_url(); ?>">
	<div class="row">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 padding-5">
			<label>SQ No.</label>
			<input type="text" class="form-control input-sm search-box" name="sqNo" value="<?php echo $sqNo; ?>" />
		</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 padding-5 hide">
			...
			<select class="form-control input-sm" name="approval">
				<option value="all">ทั้งหมด</option>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive" id="double-scroll">
		<table class="table table-striped table-hover table-narrow border-1" style="min-width:1430px; border-collapse:inherit;">
			<thead>
