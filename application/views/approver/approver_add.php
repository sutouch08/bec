...
<form class="form-horizontal" id="addForm" method="post">
    ...
    <div class="col-xs-12 col-sm-3">
			<input type="text" name="name" id="name" class="width-100" style="height:34px; font-size:14px;" disabled />
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-12">
			...
			<input type="number" id="discPrcnt" class="form-control input-sm text-center" style="height:34px; font-size:14px;" value="0.00">
