...
<div class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<select class="form-control input-sm r" id="user">
				...
				<?php echo select_user_id($approver->user_id); ?>
			</select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="status" value="1" <?php echo ($approver->status == 1 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; Active</span>
			</label>
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="status" value="0" <?php echo ($approver->status == 0 ? 'checked' : ''); ?> />
	...
	<div class="form-group">
		...
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="ap_order" value="1" <?php echo ($approver->ap_order == 1 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; Yes</span>
			</label>
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="ap_order" value="0" <?php echo ($approver->ap_order == 0 ? 'checked' : ''); ?> />
	...
	<div class="form-group">
		...
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="ap_promotion" value="1" <?php echo ($approver->ap_promotion == 1 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; Yes</span>
			</label>
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="ap_promotion" value="0" <?php echo ($approver->ap_promotion == 0 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; No</span>
			</label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="visible_gp" value="1" <?php echo ($approver->visible_gp == 1 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; Yes</span>
			</label>
			<label class="fix-width-100" style="margin-top:7px;">
				<input type="radio" class="ace" name="visible_gp" value="0" <?php echo ($approver->visible_gp == 0 ? 'checked' : ''); ?> />
				<span class="lbl">&nbsp; No</span>
			</label>
		</div>
	</div>
						...
						<?php foreach ($sales_team as $rs) : ?>
							<tr>
								<td class="text-center">
									<label>
										<input type="checkbox" class="ace chk-team" value="<?php echo $rs->id; ?>" <?php echo in_array($rs->id, $ap_team) ? 'checked' : ''; ?> />
										<span class="lbl"></span>
									</label>
								</td>
					...
					<?php if (!empty($brand)) : ?>
						<?php foreach ($brand as $rs) : ?>
							...
							<tr>
								<td class="text-center">
									<label>
										<input type="checkbox" class="ace chk-brand" id="brand-chk-<?php echo $rs->id; ?>" value="<?php echo $rs->id; ?>" data-id="<?php echo $rs->id; ?>" <?php echo $chk; ?> />
										<span class="lbl"></span>
									</label>
								</td>
								<td><?php echo $rs->code; ?></td>
								<td><?php echo $rs->name; ?></td>
								<td>
									<input type="number" class="form-control input-xs text-center disc r" id="brand-disc-<?php echo $rs->id; ?>" data-id="<?php echo $rs->id; ?>" value="<?php echo $val; ?>" />
								</td>
							</tr>
						<?php endforeach; ?>
					<?php endif; ?>
	...
	<div class="form-group">		
		<div class="col-lg-3 col-lg-offset-3 col-md-3 col-md-offset-3 col-sm-3 col-sm-offset-3 col-xs-12">
			<button type="button" class="btn btn-white btn-success btn-100" onclick="update()">Update</button>
		</div>
	</div>
