...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
		<table class="table table-striped border-1 table-narrow" style="min-width:600px;">
			<thead>
				<tr>
...
<script src="<?php echo base_url(); ?>scripts/masters/uom.js?v=<?php echo date('Ymd'); ?>"></script>
