...
<div class="form-horizontal margin-top-30">
  ...
  <div class="form-group">
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
      <button type="button" class="btn btn-white btn-success btn-100 btn-block-xs" onclick="update()"><i class="fa fa-save"></i> Update</button>
    </div>
  </div>  
  <input type="hidden" id="id" value="<?php echo $id; ?>" />
</div>

<script src="<?php echo base_url(); ?>scripts/masters/product_type.js?v=<?php echo date('Ymd'); ?>"></script>
