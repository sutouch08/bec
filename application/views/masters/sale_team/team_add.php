...
<div class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2-harf col-xs-8">
      <input type="text" class="form-control input-sm r" id="code" maxlength="20" value="" autocomplete="off" autofocus />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4 col-md-4 col-sm-5 col-xs-8">
      <input type="text" class="form-control input-sm r" id="name" maxlength="100" value="" autocomplete="off" />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2-harf col-xs-4">
      <input type="text" class="form-control input-sm text-right" id="reserve-amount" value="0.00" placeholder="Set the maximum reserve value per user for this team." />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2-harf col-xs-4">
      <div class="input-group">
        <input type="text" class="form-control input-sm text-right" id="reserve-age" value="0" placeholder="Set the maximum reserve age per user for this team." />
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2-harf col-xs-4">
      <div class="input-group">
        <input type="text" class="form-control input-sm text-right" id="draft-age" value="0" placeholder="Set the maximum draft age per user for this team." />
        <span class="input-group-addon">days</span>
      </div>
    </div>
