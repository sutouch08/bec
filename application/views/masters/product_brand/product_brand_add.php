...
<form class="form-horizontal" id="addForm" method="post">
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="name" id="name" class="width-100" max-length="100" value="" required />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
      <p class="pull-right">
        ...
        <button type="button" class="btn btn-sm btn-success btn-100" onclick="save()"> Add</button>
				<?php endif; ?>
      </p>
    </div>
