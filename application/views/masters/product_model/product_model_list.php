...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
    <table class="table table-striped border-1 table-narrow" style="min-width: 800px;">
      <thead>
        <tr>
          ...
          <th class="fix-width-150">Last update</th>
          <th class="fix-width-150">Last sync</th>
        </tr>
      </thead>
      <tbody>
        <?php if (!empty($data)) : ?>
          <?php $pageNo = get_zero(intval($this->uri->segment($this->segment))); ?>
          <?php $no = $pageNo + 1; ?>
