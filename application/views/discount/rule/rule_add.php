...
<div class="row">
  ...
  <div class="col-lg-4 col-md-7-harf col-sm-7 col-xs-8 padding-5">
    ...
    <input type="text" class="form-control input-sm" maxlength="200" id="name" value="" autocomplete="off" autofocus />
  </div>
  <div class="col-lg-1-harf col-md-2-harf col-sm-3 col-xs-6 padding-5">
    ...
    <select class="form-control input-sm" id="condition-type" onchange="updateConditionLayout()">
      ...
      <option value="N">Price Override</option>
  ...
  <div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-3 padding-5">
    ...
    <label style="height: 22px; padding-top:4px;">
      <input class="ace ace-switch ace-switch-6" type="checkbox" id="active" value="1" checked />
      <span class="lbl"></span>
    </label>
  </div>
    ...
    <div class="tabable">
      ...
      <div class="tab-content">
        <div id="products-tab" class="tab-pane fade active in">
          <?php $this->load->view('discount/rule/add_product_tab'); ?>
        </div>


        <div id="conditions-tab" class="tab-pane fade">
          <?php $this->load->view('discount/rule/add_condition_tab'); ?>
        </div>
      </div>
    </div>
  </div>
...
<input type="hidden" id="all-product" value="0" />
<input type="hidden" id="all-customer" value="0" />
<input type="hidden" id="all-channels" value="1" />
<input type="hidden" id="all-payments" value="1" />
<input type="hidden" id="can-group" value="0" />
