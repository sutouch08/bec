...
<form class="form-horizontal" id="addForm" method="post">
    ...
    <div class="col-xs-12 col-sm-3">
			<input type="text" name="profileName" id="profileName" class="width-100" value="" autofocus required />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-3">
      <p class="pull-right">
        <button type="button" class="btn btn-sm btn-success" style="width:100px;" onclick="save()">Add</button>
      </p>
    </div>
