...
<form class="form-horizontal" id="resetForm" method="post">
    ...
    <div class="col-xs-12 col-sm-3">
        ...
        <input type="text" name="uname" id="uname" class="width-100" value="<?php echo $data->code; ?>" disabled />
  ...
  <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-3">
      <p class="pull-right">
        <button type="button" class="btn btn-sm btn-success" onclick="save()">Change password</button>
      </p>
    </div>
