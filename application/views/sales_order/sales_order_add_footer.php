  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 text-right">
    ...
    <div class="btn-group dropup">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
        <li class="primary"><a id="btn-draft" href="javascript:saveAsDraft('add')">Save as Draft</a></li>
        <li class="purple"><a id="btn-reserv" href="javascript:saveAsReserve('add')">Save AS Reserv</a></li>
        <li class="success"><a id="btn-save" href="javascript:validateFreeItem('add')">Save</a></li>
      </ul>
    </div>
