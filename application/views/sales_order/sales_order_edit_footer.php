<div class="row">
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-xs-6 padding-5 last">
          ...
          <input type="text" id="docTotalLabel" class="form-control input-sm text-right" value="<?php echo number($order->DocTotal, 2); ?>" readonly/>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 text-right">
    <button type="button" class="btn btn-sm btn-primary btn-100" onclick="validateFreeItem('update')">Save</button>
